...
namespace 发票
{
    partial class main
    {
        ...
        private void InitializeComponent()
        {
            ...
            编辑分类.Location = new Point(14, 545);
            ...
            textBox3.Location = new Point(14, 595);
            ...
            textBox4.Location = new Point(14, 633);
            ...
            Modlechoose.Location = new Point(492, 122);
            Modlechoose.MinimumSize = new Size(1, 1);
            Modlechoose.Name = "Modlechoose";
            Modlechoose.Size = new Size(156, 35);
            ...
            showFomat.Size = new Size(486, 223);
            ...
            listBox1.Location = new Point(16, 209);
            ...
            LoadTemplate.Location = new Point(167, 547);
            ...
            // 使用说明
            // 
            使用说明.Font = new Font("宋体", 12F, FontStyle.Regular, GraphicsUnit.Point, 134);
            使用说明.Location = new Point(320, 547);
            使用说明.Margin = new Padding(5, 4, 5, 4);
            使用说明.MinimumSize = new Size(1, 1);
            使用说明.Name = "使用说明";
            使用说明.Radius = 15;
            使用说明.Size = new Size(143, 33);
            使用说明.TabIndex = 41;
            使用说明.Text = "使用说明";
